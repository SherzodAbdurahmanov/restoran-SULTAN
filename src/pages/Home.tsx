...
function Home() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8 text-center md:text-left">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-amber-500 leading-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link to="/menu" className="bg-gradient-to-r from-amber-600 to-yellow-500 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:from-amber-500 hover:to-yellow-400 transition-all shadow-lg shadow-amber-900/50 hover:shadow-xl hover:shadow-amber-900/70 font-semibold text-base sm:text-lg">
                  Посмотреть меню
                </Link>
                <a href="https://wa.me/996226500800" target="_blank" rel="noopener noreferrer" className="bg-transparent text-amber-500 px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-amber-900/20 transition-all shadow-lg font-semibold text-base sm:text-lg border-2 border-amber-600">
                  Связаться с нами
                </a>
              </div>
            </div>
            <div className="relative mt-8 md:mt-0">
              ...
              <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl shadow-amber-900/50">
      ...
      {/* Features */}
      <section className="py-12 sm:py-16 md:py-20 bg-zinc-950 border-y border-amber-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-6 sm:p-8 rounded-2xl hover:bg-amber-950/30 transition-all duration-300 group border border-amber-900/20">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-600 to-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-amber-900/50">
                <ChefHat className="w-7 h-7 sm:w-8 sm:h-8 text-black" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-amber-500 mb-3 sm:mb-4">Мастер-шефы</h3>
            ...
            <div className="text-center p-6 sm:p-8 rounded-2xl hover:bg-amber-950/30 transition-all duration-300 group border border-amber-900/20">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-600 to-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-amber-900/50">
                <Utensils className="w-7 h-7 sm:w-8 sm:h-8 text-black" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-amber-500 mb-3 sm:mb-4">Авторская кухня</h3>
              <p className="text-sm sm:text-base text-amber-100/80 leading-relaxed">
                Уникальные блюда, сочетающие традиции и современные тренды
              </p>
            </div>
            <div className="text-center p-6 sm:p-8 rounded-2xl hover:bg-amber-950/30 transition-all duration-300 group border border-amber-900/20 sm:col-span-2 md:col-span-1">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-600 to-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-amber-900/50">
                <Utensils className="w-7 h-7 sm:w-8 sm:h-8 text-black" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-amber-500 mb-3 sm:mb-4">Халяльные продукты</h3>
              <p className="text-sm sm:text-base text-amber-100/80 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-amber-500">О ресторане</h2>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-4 sm:pt-6">
                <div className="space-y-2">
                  <div className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">5+</div>
                  <div className="text-sm sm:text-base text-amber-200/70">Лет опыта</div>
                </div>
                <div className="space-y-2">
                  <div className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">50+</div>
                  <div className="text-sm sm:text-base text-amber-200/70">Блюд в меню</div>
                </div>
                <div className="space-y-2">
                  <div className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">10K+</div>
                  <div className="text-sm sm:text-base text-amber-200/70">Довольных гостей</div>
                </div>
                <div className="space-y-2">
                  <div className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">5★</div>
                  <div className="text-sm sm:text-base text-amber-200/70">Рейтинг</div>
                </div>
              </div>
            </div>
      ...
      {/* Menu Preview */}
      <section id="menu-preview" className="py-12 sm:py-16 md:py-20 bg-zinc-950 border-t border-amber-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-amber-500 mb-4">Наше меню</h2>
          ...
          <div className="text-center mt-8 sm:mt-10 md:mt-12">
            <Link to="/menu" className="bg-gradient-to-r from-amber-600 to-yellow-500 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:from-amber-500 hover:to-yellow-400 transition-all shadow-lg shadow-amber-900/50 hover:shadow-xl hover:shadow-amber-900/70 font-semibold text-base sm:text-lg inline-block">
